...
using InventorySafe.Core.Services;
...
public partial class App : Application
{
    ...
    private void ConfigureServices(HostBuilderContext context, IServiceCollection services)
    {
        ...
        services.AddSingleton<ISqliteHandler, SqliteHandler>();
        ...
        services.AddTransient<ProductGridPage>();

        services.AddTransient<ContentGridPage>();
        services.AddTransient<ListDetailsPage>();
        services.AddTransient<ShopItemGridPage>();

        //services.AddTransient<ContentGridDetailPage>();
        Helpers.SqliteHandler.Instance.CreateConnection();
        //services.AddTransient<ListDetailsPage>();
